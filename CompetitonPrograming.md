...
- 問題文を読み込み、整理する
      - 何を問われているのか
      - どこまで分かっていて、その解法をどう実装するのか
      - わからないこと、曖昧なことは何なのか。どうググれば解決策を得られそうなのか
      - 後回しにして、次の問題に進むべきかどうか
...
## 所感
- 競技プログラミングは、論理的かつ建設的な話をするために必要な技能が身に付けられるものだと思う
- 「実現したい何か」と「それの承認を通さなければならない誰か（複数であることが多い）」のそれぞれの立場や思惑、情報量の差という要素を組み合わせたベン図を頭の中で描き、
      - 何が足りないのか
      - 足りないものが複数あるとしたら、それぞれの優先順位はどうなっているのか
      - 妥協できるものはあるのか
次に考えるべきこうした内容を整理することができる
